...
var ML_SERVICES_EXACT = {
     ...
     * doesn't really benefit from more than one instance.
     */
    ops: 1,
    madtom: 1,
    ...
    /*
     * "rebalancer" is an optional component for evacuating storage nodes.
     */
    rebalancer: 0,
...
var ML_SERVICES_PER_SHARD = {
    ...
    'buckets-mdapi': ML_NPERSHARD_INSTANCES
};
...
var ML_FRONTDOOR_RATIOS = {
    ...
    'buckets-mdplacement': ML_FRONTDOOR_NMAXINSTANCES,
...
function generateLayout(args) {
    ...
    if (extrastorage !== null) {
        layout.ml_warnings.push(
            new VError('datacenters have different numbers of storage servers.')
        );
    }
