        ...
        [
            ...
            function(subcb) {
                ...
                sapi.listInstances(opts, function(err, insts) {
                    ...
                    /*
                     * Find the highest-numbered storage|minio id and pick
                     * the next one.
                     */
                    ...
                    if (svc.name === 'storage') {
                        ...
                        metadata.MANTA_MINIO_ID = mStorageFlavorId;
                        params.tags.manta_minio_id = mStorageFlavorId;
                    }
                    subcb();
                });
            },
 ...
 */
function pickNextStorageFlavorId(instances, svcname, svctype) {
