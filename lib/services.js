...
var mSvcConfigs = {
	...
	'jobsupervisor': {
		...
		'probes': true,
		'sharded': false,
		'imageNames': ['mantav2-jobsupervisor', 'manta-jobsupervisor']
	},
	'jobpuller': {
		'oneach': true,
		'probes': true,
		'sharded': false,
		'imageNames': ['mantav2-jobpuller', 'manta-jobpuller']
	},
	'medusa': {
		'oneach': true,
		'probes': true,
		'sharded': false,
		'imageNames': ['mantav2-medusa', 'manta-medusa']
	},
	'ops': {
		'oneach': true,
		'probes': true,
	...
	'marlin-dashboard': {
		...
		'sharded': false,
		'imageNames': [
		    'mantav2-marlin-dashboard', 'manta-marlin-dashboard']
	},
	'reshard': {
		'oneach': true,
		'probes': true,
	...
	'garbage-collector': {
		...
		'sharded': false,
		'imageNames': [
		    'mantav2-garbage-collector', 'manta-garbage-collector']
	},
	'prometheus': {
		'oneach': true,
		'probes': true,
	...
	'marlin': {
		...
		'probes': false,
		'sharded': false,
		// No need for a mantav1/mantav2 distinction for the compute zone image
